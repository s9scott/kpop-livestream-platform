...
const LiveStreamsButton = ({ setVideoId }) => {
  ...
  return (
    <div>
      <button onClick={togglePopup} className="bg-primary text-white px-5 py-2 rounded-lg text-sm hover:bg-red-600 transition duration-200 ease-in-out shadow-md">
        view livestreams
      </button>
