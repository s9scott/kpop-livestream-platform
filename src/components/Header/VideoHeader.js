  ...
  return (
    <div className="bg-base-100 content-center w-9/12 items-center justify-center p-4 rounded-lg shadow-md">
      <form onSubmit={handleSubmit} className="flex items-center space-x-4 w-full">
        ...
        />
        <button type="submit" className="px-4 py-2 text-xsm bg-primary text-black whitespace-nowrap font-semibold bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
          Load Video
        </button>
        <button type="button" onClick={handleReset} className="px-4 py-2 text-xsm bg-red text-black whitespace-nowrap font-semibold rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">
          Reset Settings
        </button>
